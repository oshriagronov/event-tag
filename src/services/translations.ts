...
export const translations = {
  he: {
    ...
    legal: {
      ...
      lastUpdated: 'עודכן לאחרונה: 15 ביולי 2026',
      ...
      privacySection1Bullets: [
        'זיהוי הפנים, קיבוץ הפנים (Clustering) והשיוך לאורחים מתבצעים באמצעות מודלי בינה מלאכותית מקומיים (@vladmandic/face-api הפועל על גבי TensorFlow.js בדפדפן).',
  ...
  en: {
    ...
    legal: {
      ...
      privacySection1Bullets: [
        'Face detection, facial recognition, and clustering processes are executed on-device using client-side AI models (@vladmandic/face-api running via TensorFlow.js in the browser).',
